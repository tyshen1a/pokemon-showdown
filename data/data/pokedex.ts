export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	vileplume: {
        	...
        	name: "Vileplume",
        	types: ["Grass", "Poison"],
        	baseStats: {hp: 75, atk: 80, def: 85, spa: 110, spd: 90, spe: 80},
        	abilities: {0: "Chlorophyll", 1: "Corrosion"},
        	heightm: 1.2,
        	weightkg: 18.6,
        	color: "Red",
        	prevo: "Gloom",
	...
	bellossom: {
        	...
        	name: "Bellossom",
        	types: ["Grass"],
        	baseStats: {hp: 75, atk: 80, def: 85, spa: 90, spd: 110, spe: 80},
	...
	roserade: {
        	...
        	abilities: {0: "Poison Touch", 1: "Technician"},
        	heightm: 0.9,
        	weightkg: 14.5,
        	color: "Green",
        	prevo: "Roselia",
